...
function checkuser() {
    ...
    if ((login == listeuser[0][0] && mdp == listeuser[0][1])){
        document.location.href = "../html/Moncompte.html?id=listeuser[0][0]";
    }
    else if (login == listeuser[1][0] && mdp == listeuser[1][1]){
        document.location.href = "../html/Moncompte.html?id=listeuser[1][0]";
     
    }
    else if (login == listeuser[2][0] && mdp == listeuser[2][1]){
        document.location.href = "../html/Moncompte.html?id=listeuser[2][0]";
     
    }
    else {
        document.getElementById("compte").reset();
